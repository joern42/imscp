=head1 NAME
 ...
 Package::Setup::PhpMyAdmin - i-MSCP PhpMyAdmin package
...
package Package::Setup::PhpMyAdmin;

use strict;
use warnings;
use Class::Autouse qw/ :nostat Package::Setup::PhpMyAdmin::Installer Package::Setup::PhpMyAdmin::Uninstaller /;
use iMSCP::Config;
use iMSCP::Debug;
...
sub registerSetupListeners
{
    ...
    Package::Setup::PhpMyAdmin::Installer->getInstance()->registerSetupListeners( $eventManager );
}
...
sub preinstall
{
    Package::Setup::PhpMyAdmin::Installer->getInstance()->preinstall();
}
...
sub install
{
    Package::Setup::PhpMyAdmin::Installer->getInstance()->install();
}
...
sub uninstall
{
    ...
    Package::Setup::PhpMyAdmin::Uninstaller->getInstance()->uninstall();
}
...
=item _init( )
 ...
 Return Package::Setup::PhpMyAdmin
