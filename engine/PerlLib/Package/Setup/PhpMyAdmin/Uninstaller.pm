=head1 NAME
 ...
 Package::Setup::PhpMyAdmin::Uninstaller - i-MSCP PhpMyAdmin package uninstaller
...
package Package::Setup::PhpMyAdmin::Uninstaller;
...
=item _init( )
 ...
 Return Package::Setup::PhpMyAdmin::Uninstaller
