=head1 NAME
 ...
 Package::Setup::AntiRootkits::Chkrootkit::Installer - i-MSCP Chkrootkit package installer
...
package Package::Setup::AntiRootkits::Chkrootkit::Installer;
...
sub _addCronTask
{
    Servers::cron->factory()->addTask( {
        TASKID  => 'Package::Setup::AntiRootkits::Chkrootkit',
        MINUTE  => '@weekly',
        HOUR    => '',
        DAY     => '',
        MONTH   => '',
