...
package Package::Setup::FileManager::Pydio::Pydio;

use strict;
use warnings;
use Class::Autouse qw/ :nostat Package::Setup::FileManager::Pydio::Installer Package::Setup::FileManager::Pydio::Uninstaller /;
use iMSCP::Rights;
...
sub preinstall
{
    Package::Setup::FileManager::Pydio::Installer->getInstance()->preinstall();
}
...
sub install
{
    Package::Setup::FileManager::Pydio::Installer->getInstance()->install();
}
...
sub uninstall
{
    Package::Setup::FileManager::Pydio::Uninstaller->getInstance()->uninstall();
}
