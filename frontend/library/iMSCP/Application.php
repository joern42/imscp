...
class Application
{
    ...
    public function bootstrap($configFilePath)
    {
        ...
        $this->initDatabase();
        $this->mergeConfig();
        $this->setUserFrontEndProperties();
    ...
    protected function startSession()
    {
        ...
        if (!is_writable(FRONTEND_ROOT_DIR . '/data/sessions')) {
            throw new iMSCPException('The frontend/data/sessions directory is not writable.');
        }
    ...
    /**
     * Set user's frontEnd properties
     *
     * @return void
     */
    protected function setUserFrontEndProperties()
    {
        if (PHP_SAPI == 'cli'
    ...
    protected function initLocalization()
    {
        ...
        $this->translator = new Translator([
            'adapter'        => 'gettext',
            'locale'         => $locale,
            'content'        => FRONTEND_ROOT_DIR . '/i18n/locales',
            'disableNotices' => true,
