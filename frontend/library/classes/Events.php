...
class Events
{
    ...
    /**
     * Event triggered after session start
     * 
     * iMSCP_Events_Event object parameter:
     *  - context : iMSCP\Application instance
     * 
     * @const string
     */
    const onAfterSessionStart = 'onAfterSessionStart';
     ...
     *
     * iMSCP_Events_Event object parameters:
     *  - domainId : Customer primary domain unique identifier
     ...
     *
     * @see getJsTranslations() for more details
     * @const string
     */
    ...
    /**
     * Event triggered on uncaught exception
     * 
     * @const string
     */
    const onUncaughtException = 'onUncaughtException';
}
