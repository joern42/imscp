...
class OpcodeCache
{
     ...
     * @return void
     */
    static public function clearAllActive($fileAbsPath = NULL): void
    {
    ...
    static protected function initialize(): void
    {
        ...
        static::$supportedCaches = [
            ...
            'APC'               => [
                ...
                'clearCallback' => function ($fileAbsPath) {
                    if ($fileAbsPath !== NULL && OpcodeCache::getCanInvalidate('APC')) {
     ...
     */
    static public function canApcInvalidate(): bool
    {
     ...
     */
    static public function getCanInvalidate($system): bool
    {
