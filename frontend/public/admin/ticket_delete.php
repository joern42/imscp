...
if (isset($_GET['ticket_id'])) {
    ...
    Support::deleteTickets('open', Application::getInstance()->getAuthService()->getIdentity()->getUserId());
    ...
    Support::deleteTickets('closed', Application::getInstance()->getAuthService()->getIdentity()->getUserId());
