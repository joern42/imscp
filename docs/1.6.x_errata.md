...
`PhpSwitcher` plugin by using PHP versions as provided by distrbution packages
...
```shell
root@stretch:/usr/local/src/imscp# perl contrib/scripts/imscp-get-master-sql-user-pwd.pl 
