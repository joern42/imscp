...
Several changes were made in distribution package files which include new xml
tags and attributes. If you make use of your own package file through an i-MSCP
listener file, don't forget to fix it prior running the installer.
