...
[distribution package files](../src/imscp/iMSCP/Installer/Packages). If you
make use of your own package file through an i-MSCP listener file, don't
forget to fix it prior running the installer.
