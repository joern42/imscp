...
can be selected for the clients.
...
Rspamd as antispam solution. Instead, you should select the RBL Rspamd module.
...
In any case, you shouldn't make use of the postgrey server if you select Rspamd
as antispam solution. Instead, you should select the Greylisting Rspamd module.
...
In any case, you shouldn't make use of the postscreen server if you select Rspamd
as antispam solution.
...
In any case, you shouldn't make use of the SPF policy server if you select
Rspamd as antispam solution. Instead, you should select the SPF Rspamd module.
