...
Several changes were made in the [distribution packages files](../autoinstaller/Packages)
which include new xml tags and attributes. If you make use of your own packages
...
If you need support older TLS version, you can always edit the
...
plugin will be deprecated in a near future.
