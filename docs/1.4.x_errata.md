...
Note that the [iMSCP::EventManager::registerOne()](../src/iMSCP/EventManager.pm#L99)
method is a simple wrapper around the [iMSCP::EventManager::register()](../src/iMSCP/EventManager.pm#L57)
...
Distribution package files were updated. If you're using the
`10_packages_override.pl` i-MSCP listener file to override your distirbution
package file, don't forget to sync it.
