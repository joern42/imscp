...
class iMSCP_Exception_Writer_Mail extends iMSCP_Exception_Writer_Abstract
{
    ...
    public function onUncaughtException(iMSCP_Exception_Event $event)
    {
        ...
        $fileC = "<?php\n";
        $fileC .= "// File automatically generated by i-MSCP. Do not edit it manually.\n";
        $fileC .= "return " . var_export($footprints, true) . ";\n";
        @file_put_contents($footprintsCacheFile, $fileC, LOCK_EX);
    ...
    protected function prepareMailData($exception)
    {
        ...
        if (!isset($config['MASTER_ADMIN_EMAIL'])) {
            return $data;
        }
        ...
        return [
            ...
            'email' => $config['MASTER_ADMIN_EMAIL'],
