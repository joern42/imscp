 ...
 * @property string MASTER_ADMIN_EMAIL Default mail address for administrator
 ...
 * @property string SRV_DIR Directory which holds i-MSCP customer user Web directories
