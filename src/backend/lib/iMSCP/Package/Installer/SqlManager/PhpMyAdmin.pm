...
sub _buildHttpdConfig
{
    ...
    $frontEnd->buildConfFile(
        "$::imscpConfig{'SHARE_DIR'}/iMSCP/Package/Installer/SqlManager/PhpMyAdmin/imscp_pma.nginx",
...
sub _removeSqlUser
{
    ...
    iMSCP::Server::sqld->factory()->dropUser( $self->{'config'}->{'DATABASE_USER'}, $::imscpConfig{'DATABASE_USER_HOST'} );
}
