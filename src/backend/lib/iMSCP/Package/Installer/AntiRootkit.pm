=head1 NAME
 ...
 iMSCP::Package::Installer::AntiRootkit - i-MSCP AntiRootkit package collection
...
package iMSCP::Package::Installer::AntiRootkit;
...
=head1 DESCRIPTION
 ...
 i-MSCP AntiRootkit package collection.
...
sub _loadAvailablePackages
{
    ...
    local $CWD = "::imscpConfig{'SHARE_DIR'}/iMSCP/Package/Installer/" . $self->getType();
