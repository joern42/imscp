=head1 NAME
 ...
 iMSCP::Server::httpd::apache_fcgid - i-MSCP Apache2/FastCGI Server implementation
...
package iMSCP::Server::httpd::apache_fcgid;

use strict;
use warnings;
use autouse 'Date::Format' => 'time2str';
use Class::Autouse qw/ :nostat iMSCP::Server::httpd::apache_fcgid::installer iMSCP::Server::httpd::apache_fcgid::uninstaller /;
use File::Basename;
use File::Spec;
use File::Temp;
use iMSCP::Boolean;
...
sub registerInstallerDialogs
{
    ...
    iMSCP::Server::httpd::apache_fcgid::installer->getInstance()->registerInstallerDialogs( $dialogs );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Server::httpd::apache_fcgid::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Server::httpd::apache_fcgid::uninstaller->getInstance()->uninstall();
...
=item _init( )
 ...
 Return iMSCP::Server::httpd::apache_fcgid
