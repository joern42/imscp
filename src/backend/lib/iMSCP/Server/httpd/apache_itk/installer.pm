=head1 NAME
 ...
 iMSCP::Server::httpd::apache_itk::installer - i-MSCP Apache2/ITK Server implementation
...
package iMSCP::Server::httpd::apache_itk::installer;
...
use iMSCP::Server::httpd::apache_itk;
...
=item _init( )
 ...
 Return iMSCP::Server::httpd::apache_itk::installer
...
sub _installLogrotate
{
    ...
    $rs ||= $self->{'httpd'}->buildConfFile( 'logrotate.conf', {}, {
        destination => '/etc/logrotate.d/apache2'
    } );
