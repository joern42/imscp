=head1 NAME
 ...
 iMSCP::Server::httpd::apache_fcgid::installer - i-MSCP Apache2/FastCGI Server implementation
...
package iMSCP::Server::httpd::apache_fcgid::installer;
...
use iMSCP::InputValidation qw/ isOneOfStringsInList /;
use iMSCP::Dir;
use iMSCP::Execute 'execute';
use iMSCP::File;
use iMSCP::Getopt;
use iMSCP::ProgramFinder;
use iMSCP::Server::httpd::apache_fcgid;
...
=item _init( )
 ...
 Return iMSCP::Server::httpd::apache_fcgid::installer
...
sub _buildFastCgiConfFiles
{
    ...
    $self->{'httpd'}->setData( {
        USER_PREFIX   => $::imscpConfig{'USER_PREFIX'},
        USER_MIN_UID  => $::imscpConfig{'USER_MIN_UID'},
...
=item _setupVlogger( )
 ...
 Return int 0 on success, other or die failure
