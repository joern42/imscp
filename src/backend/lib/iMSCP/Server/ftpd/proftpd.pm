=head1 NAME
 ...
 iMSCP::Server::ftpd::proftpd - i-MSCP ProFTPD Server implementation
...
package iMSCP::Server::ftpd::proftpd;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Server::ftpd::proftpd::installer iMSCP::Server::ftpd::proftpd::uninstaller /;
use File::Basename;
use File::Temp;
use iMSCP::Boolean;
...
sub registerInstallerDialogs
{
    ...
    iMSCP::Server::ftpd::proftpd::installer->getInstance()->registerInstallerDialogs( $dialogs );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Server::ftpd::proftpd::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Server::ftpd::proftpd::uninstaller->getInstance()->uninstall();
...
=item _init( )
 ...
 Return iMSCP::Server::ftpd::proftpd
