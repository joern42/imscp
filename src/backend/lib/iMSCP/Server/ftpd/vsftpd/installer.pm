=head1 NAME
 ...
 iMSCP::Server::ftpd::vsftpd::installer - i-MSCP VsFTPd Server implementation
...
package iMSCP::Server::ftpd::vsftpd::installer;
...
=item _init( )
 ...
 Return iMSCP::Server::ftpd::vsftpd::installer
...
sub _buildConfigFile
{
    ...
    my $data = {
        ...
        FRONTEND_USER_SYS_NAME => $::imscpConfig{'USER_PREFIX'} . $::imscpConfig{'USER_MIN_UID'},
