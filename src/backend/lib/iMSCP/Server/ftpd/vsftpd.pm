=head1 NAME
 ...
 iMSCP::Server::ftpd::vsftpd - i-MSCP VsFTPd Server implementation
...
package iMSCP::Server::ftpd::vsftpd;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Server::ftpd::vsftpd::installer iMSCP::Server::ftpd::vsftpd::uninstaller /;
use File::Basename;
use File::Temp;
use iMSCP::Boolean;
use iMSCP::Config;
...
sub registerInstallerDialogs
{
    ...
    iMSCP::Server::ftpd::vsftpd::installer->getInstance()->registerInstallerDialogs( $dialogs );
}
...
sub install
{
    ...
    $rs ||= iMSCP::Server::ftpd::vsftpd::installer->getInstance()->install();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Server::ftpd::vsftpd::uninstaller->getInstance()->uninstall();
...
=item _init( )
 ...
 Return iMSCP::Server::ftpd::vsftpd
