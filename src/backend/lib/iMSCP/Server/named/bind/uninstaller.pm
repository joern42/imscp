=head1 NAME
 ...
 iMSCP::Server::named::bind::uninstaller - i-MSCP Bind9 Server implementation
...
package iMSCP::Server::named::bind::uninstaller;
...
=item _init( )
 ...
 Return iMSCP::Server::named::bind::uninstaller
