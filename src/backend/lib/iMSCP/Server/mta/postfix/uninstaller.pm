=head1 NAME
 ...
 iMSCP::Server::mta::postfix::uninstaller - i-MSCP Postfix MTA server uninstaller implementation
...
package iMSCP::Server::mta::postfix::uninstaller;
...
=item _init( )
 ...
 Return iMSCP::Server::mta::postfix::uninstaller
