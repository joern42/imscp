=head1 NAME
 ...
 iMSCP::Server::mta::postfix::installer - i-MSCP Postfix MTA server installer implementation
...
package iMSCP::Server::mta::postfix::installer;
...
=item _init( )
 ...
 Return iMSCP::Server::mta::postfix::installer
...
sub _buildAliasesDb
{
    ...
    $cfgTpl =~ s/^root:.*\n//gim;
    $cfgTpl .= 'root: ' . ::setupGetQuestion( 'MASTER_ADMIN_EMAIL' ) . "\n";
