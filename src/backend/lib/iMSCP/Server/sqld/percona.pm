=head1 NAME
 ...
 iMSCP::Server::sqld::percona - i-MSCP Percona server implementation
...
package iMSCP::Server::sqld::percona;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Server::sqld::percona::installer iMSCP::Server::sqld::percona::uninstaller /;
use iMSCP::Service;
...
sub preinstall
{
    ...
    $rs ||= iMSCP::Server::sqld::percona::installer->getInstance()->preinstall();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Server::sqld::percona::uninstaller->getInstance()->uninstall();
