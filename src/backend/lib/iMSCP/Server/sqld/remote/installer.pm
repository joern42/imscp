=head1 NAME
 ...
 iMSCP::Server::sqld::remote::installer - i-MSCP Remote SQL server installer implementation
...
package iMSCP::Server::sqld::remote::installer;
...
use iMSCP::Dir;
use iMSCP::File;
use iMSCP::Server::sqld::remote;
use iMSCP::TemplateParser 'processByRef';
use iMSCP::Umask '$UMASK';
use version;
use parent 'iMSCP::Server::sqld::mysql::installer';
...
=item _init( )
 ...
 Return iMSCP::Server::sqld::remote:installer
...
sub _init
{
    ...
    $self->{'sqld'} = iMSCP::Server::sqld::remote->getInstance();
