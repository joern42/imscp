=head1 NAME
 ...
 iMSCP::Server::sqld::mysql::uninstaller - i-MSCP MySQL server uninstaller implementation
...
package iMSCP::Server::sqld::mysql::uninstaller;
...
=item _init( )
 ...
 Return iMSCP::Server::sqld::mysql:uninstaller
