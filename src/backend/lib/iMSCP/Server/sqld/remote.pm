=head1 NAME
 ...
 iMSCP::Server::sqld::remote - i-MSCP Remote SQL server implementation
...
package iMSCP::Server::sqld::remote;

use strict;
use warnings;
use Class::Autouse qw/ :nostat iMSCP::Server::sqld::remote::installer iMSCP::Server::sqld::remote::uninstaller /;
use iMSCP::Boolean;
...
sub preinstall
{
    ...
    $rs ||= iMSCP::Server::sqld::remote::installer->getInstance()->preinstall();
...
sub uninstall
{
    ...
    $rs ||= iMSCP::Server::sqld::remote::uninstaller->getInstance()->uninstall();
