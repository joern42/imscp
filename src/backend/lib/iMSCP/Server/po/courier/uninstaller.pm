=head1 NAME
 ...
 iMSCP::Server::po::courier::uninstaller - i-MSCP Courier server uninstaller
...
package iMSCP::Server::po::courier::uninstaller;
...
=item _init( )
 ...
 Return iMSCP::Server::po::courier::uninstaller
...
sub _dropSqlUser
{
    ...
    iMSCP::Server::sqld->factory()->dropUser( $self->{'config'}->{'AUTHDAEMON_DATABASE_USER'}, $dbUserHost );
    0;
}
