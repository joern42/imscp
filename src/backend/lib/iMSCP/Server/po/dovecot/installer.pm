=head1 NAME
 ...
 iMSCP::Server::po::dovecot::installer - i-MSCP Dovecot IMAP/POP3 Server installer implementation
...
package iMSCP::Server::po::dovecot::installer;
...
=item _init( )
 ...
 Return iMSCP::Server::po::dovecot::installer
...
sub _migrateFromCourier
{
    ...
    $rs = execute(
        [
            'perl', "$::imscpConfig{'SBIN_DIR'}/vendor/courier-dovecot-migrate.pl", '--to-dovecot', '--quiet', '--convert',
    ...
    unless ( $rs ) {
        ...
        $::imscpOldConfig{'PO_PACKAGE'} = 'iMSCP::Server::po::dovecot';
    }
