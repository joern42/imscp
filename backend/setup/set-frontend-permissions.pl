...
=head1 NAME
 ...
 set-frontend-permissions Set i-MSCP FrontEnd permissions

=head1 SYNOPSIS

 set-frontend-permissions [options]...
...
newDebug( 'imscp-set-frontend-permissions.log' );

iMSCP::Getopt->parseNoDefault( sprintf( 'Usage: perl %s [OPTION]...', basename( $0 )) . qq{

Set i-MSCP frontend permissions.
